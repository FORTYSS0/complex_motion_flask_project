...
def generate_all_plots(data):
    ...
    # ---- 4. Новый статичный PNG: траектория с векторами скоростей (2a) ----
    generate_static_trajectory_with_velocities(data)

    # ---- 5. Новый статичный PNG: траектория с векторами ускорений (3a) ----
...
def generate_static_trajectory_with_velocities(data):
    ...
    colors = ['blue', 'green', 'orange', 'purple']
    labels = ['V_rel', 'V_rot', 'V_trans_post', 'V_abs']
    scale_len = axis_len * 0.6  # как в интерактивном
